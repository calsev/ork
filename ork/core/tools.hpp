...
#define ORK_CALL_0_EACH_00_(CALL)
#define ORK_CALL_0_EACH_01_(CALL, A1) CALL(A1)
#define ORK_CALL_0_EACH_02_(CALL, A1, A2) CALL(A1) CALL(A2)
#define ORK_CALL_0_EACH_03_(CALL, A1, A2, A3) CALL(A1) CALL(A2) CALL(A3)
#define ORK_CALL_0_EACH_04_(CALL, A1, A2, A3, A4) CALL(A1) CALL(A2) CALL(A3) CALL(A4)
#define ORK_CALL_0_EACH_05_(CALL, A1, A2, A3, A4, A5) CALL(A1) CALL(A2) CALL(A3) CALL(A4) CALL(A5)
#define ORK_CALL_0_EACH_06_(CALL, ARG, ...) CALL(ARG) ORK_EVAL(ORK_CALL_0_EACH_05_(CALL, __VA_ARGS__))
#define ORK_CALL_0_EACH_07_(CALL, ARG, ...) CALL(ARG) ORK_EVAL(ORK_CALL_0_EACH_06_(CALL, __VA_ARGS__))
#define ORK_CALL_0_EACH_08_(CALL, ARG, ...) CALL(ARG) ORK_EVAL(ORK_CALL_0_EACH_07_(CALL, __VA_ARGS__))
#define ORK_CALL_0_EACH_09_(CALL, ARG, ...) CALL(ARG) ORK_EVAL(ORK_CALL_0_EACH_08_(CALL, __VA_ARGS__))

#define ORK_CALL_0_EACH(CALL, ...) ORK_EVAL( \
	ORK_GET_ARG_09_( \
