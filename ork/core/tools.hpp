...
#define ORK_MAKE_STRING(TYPE, PRE, STR, ARG) ORK_EVAL(const TYPE ORK_CAT(PRE, ARG){STR(ORK_STR(ARG))};)
#define ORK_STRING_LIST_00(TYPE, PRE, STR)
#define ORK_STRING_LIST_01(TYPE, PRE, STR, ARG) ORK_EVAL(ORK_MAKE_STRING(TYPE, PRE, STR, ARG))
#define ORK_STRING_LIST_02(TYPE, PRE, STR, ARG, ...) ORK_EVAL(ORK_MAKE_STRING(TYPE, PRE, STR, ARG) ORK_STRING_LIST_01(TYPE, PRE, STR, __VA_ARGS__))
#define ORK_STRING_LIST_03(TYPE, PRE, STR, ARG, ...) ORK_EVAL(ORK_MAKE_STRING(TYPE, PRE, STR, ARG) ORK_STRING_LIST_02(TYPE, PRE, STR, __VA_ARGS__))
#define ORK_STRING_LIST_04(TYPE, PRE, STR, ARG, ...) ORK_EVAL(ORK_MAKE_STRING(TYPE, PRE, STR, ARG) ORK_STRING_LIST_03(TYPE, PRE, STR, __VA_ARGS__))
#define ORK_STRING_LIST_05(TYPE, PRE, STR, ARG, ...) ORK_EVAL(ORK_MAKE_STRING(TYPE, PRE, STR, ARG) ORK_STRING_LIST_04(TYPE, PRE, STR, __VA_ARGS__))
#define ORK_STRING_LIST_06(TYPE, PRE, STR, ARG, ...) ORK_EVAL(ORK_MAKE_STRING(TYPE, PRE, STR, ARG) ORK_STRING_LIST_05(TYPE, PRE, STR, __VA_ARGS__))
#define ORK_STRING_LIST_07(TYPE, PRE, STR, ARG, ...) ORK_EVAL(ORK_MAKE_STRING(TYPE, PRE, STR, ARG) ORK_STRING_LIST_06(TYPE, PRE, STR, __VA_ARGS__))
#define ORK_STRING_LIST_08(TYPE, PRE, STR, ARG, ...) ORK_EVAL(ORK_MAKE_STRING(TYPE, PRE, STR, ARG) ORK_STRING_LIST_07(TYPE, PRE, STR, __VA_ARGS__))
#define ORK_STRING_LIST_09(TYPE, PRE, STR, ARG, ...) ORK_EVAL(ORK_MAKE_STRING(TYPE, PRE, STR, ARG) ORK_STRING_LIST_08(TYPE, PRE, STR, __VA_ARGS__))

#define ORK_STRING_LIST(TYPE, PRE, STR, ...) ORK_EVAL(\
	ORK_GET_ARG_09( \
	...
	(TYPE, PRE, STR, __VA_ARGS__))


#define ORK_ENUM_DEF(ENUM, ...) \
ORK_STRING_LIST(ork::string, s, ORK, __VA_ARGS__) \
ORK_STRING_LIST(ork::bstring, b, BORK, __VA_ARGS__) \
ORK_STRING_LIST(ork::wstring, w, WORK, __VA_ARGS__)
// TODO: The functions
