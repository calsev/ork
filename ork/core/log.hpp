...
#define _ORK_LOG(CH, SV, UID) auto UID{ork::get_global_log().get_log_scope(ORK_FILEN, ORK_LINE, ORK_FUNC, CH, SV)}; UID
#define ORK_LOG(SV) _ORK_LOG(ork::log_channel::debug_trace, SV, ORK_UID(_ork_log_log_))
