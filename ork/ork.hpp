...
#define ORK_VERSION \
    (ORK_VERSION_MAJOR * 10000 + ORK_VERSION_MINOR * 100 + ORK_VERSION_PATCH) // 1.0 is 10000


#define ORK_VERSION_STR_ \
    ORK_STR(ORK_CAT(ORK_VERSION_MAJOR, ., ORK_VERSION_MINOR, ., ORK_VERSION_PATCH))
