...
struct butterworth<2, 4> : public detail::ring<3> {
    ORK_API double tick(double x)
    {
        static const std::array<double, BUFF_SIZE> A = {
            0.29289321881333563000, 0.58578643762667126000, 0.29289321881333563000};
        static const std::array<double, BUFF_SIZE> B = {
            1.00000000000000000000, -0.00000000000000019511, 0.17157287525380990000};
        _x.push_front(x);
        _y.push_front(A[0] * x);
...
template<>
struct butterworth<2, 8> : public detail::ring<3> {
    ORK_API double tick(double x)
    {
        static const std::array<double, BUFF_SIZE> A = {
            0.09763107689932175300, 0.19526215379864351000, 0.09763107689932175300};
        static const std::array<double, BUFF_SIZE> B = {
            1.00000000000000000000, -0.94280904158206325000, 0.33333333333333326000};
        _x.push_front(x);
        _y.push_front(A[0] * x);
        for(size_t i = 1; i != BUFF_SIZE; ++i) {
            _y[0] += A[i] * _x[i] - B[i] * _y[i];
...
template<>
struct butterworth<2, 16> : public detail::ring<3> {
    ORK_API double tick(double x)
    {
        static const std::array<double, BUFF_SIZE> A = {
            0.02995247960866337400, 0.05990495921732674800, 0.02995247960866337400};
        static const std::array<double, BUFF_SIZE> B = {
            1.00000000000000000000, -1.45424358625158500000, 0.57406191508395477000};
        _x.push_front(x);
        _y.push_front(A[0] * x);
        for(size_t i = 1; i != BUFF_SIZE; ++i) {
            _y[0] += A[i] * _x[i] - B[i] * _y[i];
...
template<>
struct butterworth<2, 32> : public detail::ring<3> {
    ORK_API double tick(double x)
    {
        static const std::array<double, BUFF_SIZE> A = {
            0.00831055513615891820, 0.01662111027231783600, 0.00831055513615891820};
        static const std::array<double, BUFF_SIZE> B = {
            1.00000000000000000000, -1.72377617276250890000, 0.75754694447882898000};
        _x.push_front(x);
        _y.push_front(A[0] * x);
        for(size_t i = 1; i != BUFF_SIZE; ++i) {
            _y[0] += A[i] * _x[i] - B[i] * _y[i];
...
template<>
struct butterworth<4, 4> : public detail::ring<5> {
    ORK_API double tick(double x)
    {
        static const std::array<double, BUFF_SIZE> A = {0.09398064470252343000,
                                                        0.37592257881009372000,
                                                        0.56388386821514058000,
                                                        0.37592257881009372000,
                                                        0.09398064470252343000};
        static const std::array<double, BUFF_SIZE> B = {1.00000000000000000000,
...
template<>
struct butterworth<4, 8> : public detail::ring<5> {
    ORK_API double tick(double x)
    {
        static const std::array<double, BUFF_SIZE> A = {0.01020853419306819500,
...
template<>
struct butterworth<4, 16> : public detail::ring<5> {
    ORK_API double tick(double x)
    {
        static const std::array<double, BUFF_SIZE> A = {0.00092507968628719654,
...
template<>
struct butterworth<4, 32> : public detail::ring<5> {
    ORK_API double tick(double x)
    {
        static const std::array<double, BUFF_SIZE> A = {0.00006661889502014782,
...
template<>
struct butterworth<8, 4> : public detail::ring<9> {
    ORK_API double tick(double x)
    {
        static const std::array<double, BUFF_SIZE> A = {0.00927650977743330230,
...
template<>
struct butterworth<8, 8> : public detail::ring<9> {
    ORK_API double tick(double x)
    {
        static const std::array<double, BUFF_SIZE> A = {0.00010881080315039874,
...
template<>
struct butterworth<8, 16> : public detail::ring<9> {
    ORK_API double tick(double x)
    {
        static const std::array<double, BUFF_SIZE> A = {0.00000095022413522387,
...
template<>
struct butterworth<8, 32> : public detail::ring<9> {
    ORK_API double tick(double x)
    {
        static const std::array<double, BUFF_SIZE> A = {0.00000000727990092326,
