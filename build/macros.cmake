...
macro(replace_or_append_all_flag_compilers _vc_regex_str _gcc_regex_str _vc_flag_str _gcc_flag_str)
	...
	if(COMPILER MATCHES "vc")
		replace_or_append_compiler_flag(CMAKE_CXX_FLAGS ${_vc_regex_str} ${_vc_flag_str})
		replace_or_append_compiler_flag(CMAKE_C_FLAGS ${_vc_regex_str} ${_vc_flag_str})
	elseif(COMPILER MATCHES "gcc")
		replace_or_append_compiler_flag(CMAKE_CXX_FLAGS ${_gcc_regex_str} ${_gcc_flag_str})
		replace_or_append_compiler_flag(CMAKE_C_FLAGS ${_gcc_regex_str} ${_gcc_flag_str})
	else()
...
macro(enable_structured_exceptions)
	get_compiler_name(COMPILER)
	if(COMPILER MATCHES "vc")
		replace_or_append_all_flag(${EH_STRINGS} "/EHa")
	endif()
endmacro()
macro(enable_synchronous_exceptions)
	get_compiler_name(COMPILER)
	if(COMPILER MATCHES "vc")
		replace_or_append_all_flag(${EH_STRINGS} "/EHs")
	endif()
endmacro()
macro(enable_only_cxx_exceptions)
	get_compiler_name(COMPILER)
	if(COMPILER MATCHES "vc")
		replace_or_append_all_flag(${EH_STRINGS} "/EHsc")
	endif()
endmacro()
